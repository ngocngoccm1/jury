...
(() => {
  ...
  if (dockLinks.length === 3) {
    dockLinks[0].href = 'JURY-Speisekarte-menu.pdf';
  ...
  if (desktopLinks.length === 3) desktopLinks[0].href = 'JURY-Speisekarte-menu.pdf';
  ...
  if (drawerMenu) drawerMenu.href = 'JURY-Speisekarte-menu.pdf';
